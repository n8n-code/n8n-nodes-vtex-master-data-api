...
export class VtexMasterDataApiApi implements ICredentialType {
	name = 'N8nDevVtexMasterDataApiApi';

	displayName = 'vtex-master-data-api API';

	icon: Icon = { light: 'file:../nodes/VtexMasterDataApi/vtex-master-data-api.svg', dark: 'file:../nodes/VtexMasterDataApi/vtex-master-data-api.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your vtex-master-data-api API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
